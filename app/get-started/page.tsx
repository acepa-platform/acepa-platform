...
export default function GetStartedPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <section className="mx-auto grid min-h-[calc(100vh-89px)] max-w-7xl items-center gap-12 px-6 py-12 lg:grid-cols-[1fr_520px] lg:px-10 lg:py-16">
        ...
        <div className="rounded-[28px] border border-slate-200 bg-white p-7 shadow-[0_20px_70px_rgba(15,23,42,0.08)] sm:p-9">
          <div>
            <p className="text-xs font-bold tracking-[0.2em] text-purple-600">CREATE YOUR ACCOUNT</p>
            <h2 className="mt-3 text-3xl font-black tracking-[-0.04em]">Get started</h2>
