      ...
      <footer className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
            <div><div className="text-3xl font-black tracking-[-0.08em]">ACEPA</div><p className="mt-5 max-w-sm text-sm leading-6 text-slate-400">A global investment and business development platform connecting people, capital, ideas, and opportunities.</p></div>
